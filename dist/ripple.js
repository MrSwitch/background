...
},{"../utils/events/createDummyEvent":4,"../utils/events/createEvent":5,"../utils/events/userinitiated":6,"../utils/support/requestAnimationFrame":7}],2:[function(require,module,exports){
// Collection
...
var _utilsTimeTimingEaseInOutCubicJs = require('./utils/time/timing.easeInOutCubic.js');

var _utilsTimeTimingEaseInOutCubicJs2 = _interopRequireDefault(_utilsTimeTimingEaseInOutCubicJs);
	...
	_createClass(Ripple, [{
		...
		value: function frame(canvas) {
			...
			if (this.t <= 0) {
				...
				this.visible = true;
				this.r = (0, _utilsTimeTimingEaseInOutCubicJs2['default'])(1 - this.t) * MAX;
				this.calc();
				this.dirty = true;
			}
		}
...
},{"./classes/canvas":1,"./classes/collection":2,"./utils/time/timing.easeInOutCubic.js":8}],4:[function(require,module,exports){
"use strict";
...
//# sourceMappingURL=../dist/ripple.js.map