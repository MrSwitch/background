...
},{"../array/toArray.js":1,"../object/instanceOf.js":11,"./isDom.js":3}],3:[function(require,module,exports){
'use strict';
...
},{"../object/instanceOf.js":11}],4:[function(require,module,exports){
"use strict";
...
},{"tricks/object/Queue":9}],14:[function(require,module,exports){
'use strict';
...
},{"tricks/events/createDummyEvent":4,"tricks/events/createEvent":5,"tricks/events/on":6,"tricks/events/swipe":7,"tricks/support/requestAnimationFrame":12}],15:[function(require,module,exports){
'use strict';
...
},{"tricks/events/on":6}],16:[function(require,module,exports){
'use strict';
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // mineField, Canvas annimation
...
},{"./classes/background":13,"./classes/canvas":14,"./classes/collection":15,"./classes/text":17,"tricks/object/extend":10}]},{},[18])
